...
var engine = props.globals.getNode("sim/model/superfrelon/engine");
...
var turbine = props.globals.getNode("sim/model/superfrelon/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/superfrelon/torque-pct", 1);
